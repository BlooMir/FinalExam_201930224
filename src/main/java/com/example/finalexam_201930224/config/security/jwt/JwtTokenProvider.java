package com.example.finalexam_201930224.config.security.jwt;
...
public class JwtTokenProvider {
    ...
    private String secretKey = "daelimSpring!@#$daelimSpring!@#$daelimSpring!@#$";    private final long tokenValidMillisecond = 1000L * 60 * 60;
    ...
    public String createToken(String userUid, List<String> roles, String userName) {
